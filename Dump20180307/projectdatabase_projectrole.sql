...
CREATE TABLE `projectrole` (
  `projectrole_id` int(11) NOT NULL AUTO_INCREMENT,
  `qualifications` varchar(45) NOT NULL,
  `other_details` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`projectrole_id`)
...
INSERT INTO `projectrole` VALUES (1,'teamlead','Vị trí không thể thiếu trong bất kỳ'),(3,'developer','lap trinh vien');
...
-- Dump completed on 2018-03-07 13:35:00
